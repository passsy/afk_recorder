chrome.storage.sync.get(null, function(items) {
  ...
  if (
    ...
    items["videoMaxFrameRates"] !== "None" &&
    items["videoMaxFrameRates"].length
  ) {
  ...
  if (items["videoResolutions"]) {
    document.getElementById("videoResolutions").value =
  ...
  if (items["fixVideoSeekingIssues"]) {
    document.getElementById("fixVideoSeekingIssues").checked =
      items["fixVideoSeekingIssues"] == "true";
  } else {
    chrome.storage.sync.set(
      {
